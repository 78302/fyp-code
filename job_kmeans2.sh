...
cd msc/fyp-code/
# python3 run_apc.py
python3 kMeans.py -n 'pretrainInput_50' -e 1 -k 50 -p './pretrain_model/model/Epoch50.pth.tar' -s './data/raw_fbank_train_si284.scp' > job_kmeans_pretrainInput_e1_k50.out
