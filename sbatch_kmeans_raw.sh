...
sbatch -p General_Usage -c 4 -d singleton -J job_kmeans_raw ./test_kmeans_copy1.sh 2000
sbatch -p General_Usage -c 4 -d singleton -J job_kmeans_raw ./test_kmeans_copy1.sh 3000
sbatch -p General_Usage -c 4 -d singleton -J job_kmeans_raw ./test_kmeans_copy1.sh 4000
